...
if ( ! function_exists( 'dgc_setup' ) ) :
	...
	function dgc_setup() {
		 ...
		 * If you're building a theme based on dgc, use a find and replace
		...
		add_theme_support( 'custom-background', apply_filters( 'dgc_custom_background_args', array(
 ...
 */
function dgc_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'dgc_content_width', 640 );
}
add_action( 'after_setup_theme', 'dgc_content_width', 0 );
...
function dgc_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'dgc' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'dgc' ),
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Site Info Menu', 'dgc' ),
		'id'            => 'site-info-menu',
		'description'   => esc_html__( 'Widget area in the footer .site-info.', 'dgc' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
		'before_title'  => '<h2 class="widget-title">',
		'after_title'   => '</h2>',
...
function dgc_scripts() {
	...
	wp_enqueue_script( 'dgc-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'dgc-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
